...
export function answerReply(status) {
  return ({ correct: '答对啦！这份默契接住了，给你送上一朵小红花～', incorrect: '这题没接住也没关系，谢谢你带着心意来参加！', review: '这一题我还拿不准，留给新人核对一下。你的回答已经记下啦。', pending: '收到啦，稍等我一下～', judging: '正在想一想…' })[status] || '这份回答已经记下啦。';
}
